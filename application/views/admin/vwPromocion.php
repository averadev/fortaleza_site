  ...
  <div class="item">
    <div class="container" style="width:900px;">
      ...
      <div class="panel panel-default" >
        ...
        <div class="panel-heading">Lista de Promociones <span style='float:right; margin-top: -7px;'><a href='#' title='View' class="btn btn-primary btnAdd"><i class="fam-plus"></i> Promociones  </a></span></div>
...
<script src="<?php echo base_url().JS; ?>api/promocion.js"></script>