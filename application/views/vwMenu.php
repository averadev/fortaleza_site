    <div class="menuBar">
        ...
        <div class="content">
            ...
            <div class="menuOpt goTo" ref="<?php echo base_url(); ?>info">INFORMATION</div>
            <div class="menuOpt bookmein" ref="<?php echo base_url(); ?>booking">BOOKING</div>
            <div class="menuOpt goTo" ref="<?php echo base_url(); ?>contacto">CONTACT</div>
        </div>
    </div>